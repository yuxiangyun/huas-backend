...
SOCIAL_API.md: Community、Discover、Treehole、Notifications 与 Messaging 用户侧后端契约，固定公共/本人资料、稳定增量、三态消息、UUID 幂等、上传错误与 Bearer Blob 边界。
OPERATIONS_API.md: 公共公告与后台 Cookie 会话契约，定义 Dashboard/Analytics/日志/策略及带最小隐私审计的私信只读管理入口。

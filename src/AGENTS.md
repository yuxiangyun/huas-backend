...
modules/: 按业务能力组织的纵向切片，承载 Identity、Campus Integrations、Academic、Calendar、Discover 与 Treehole canonical 实现
...
services/: 迁移期业务兼容层与未迁移领域服务，Discover/Treehole 等已迁领域只保留单向 Facade

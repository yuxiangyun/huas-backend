 ...
 * [OUTPUT]: 对外提供 AcademicScheduleAdapter，委托移动教务固定单源周课表及完整学期采集
...
export class AcademicScheduleAdapter implements AcademicSchedulePort {
  getMobileJwSemesterSchedule(userId: number) {
    return ScheduleFacade.getMobileJwSemesterSchedule(userId);
  }

 ...
 * [POS]: mobile-yxt 到基础学校凭证的窄端口；只失效被上游明确拒绝且仍为当前值的 Portal JWT，不读取、不激活、不覆盖也不失效 JW Session
 * [PROTOCOL]: 变更时更新此头部，然后检查 AGENTS.md
 */

import { and, eq } from 'drizzle-orm';
import { getDb, schema } from '../../../db';
import { CredentialManager } from '../credential-recovery/credential-manager';

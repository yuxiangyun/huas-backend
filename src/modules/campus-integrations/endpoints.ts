...
export const URLS = {
  ...
  mobileYxtElectricityConfig: "https://mobile-yxt.huas.edu.cn/server/utilities/config",
  mobileYxtElectricityAccount: "https://mobile-yxt.huas.edu.cn/server/utilities/account",
};

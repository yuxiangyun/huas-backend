...
discover/: 发现美食纵向切片，承载 HTTP、社区资料投影、稳定规则、SQLite 事务与本地媒体
...
treehole/: 化名树洞纵向切片，承载 HTTP、社区资料用例、公共/管理模型、SQLite 事务与头像媒体
...
变更日志
2026-07-29: Discover/Treehole 前台读模型共享 users 社区资料投影，真实校园身份仍只进入管理视图。

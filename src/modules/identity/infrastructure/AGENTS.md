...
成员清单
legacy-campus-login.adapter.ts: 既有 AuthEngine/TicketExchanger/CredentialManager/UserService 的登录端口适配器
...
架构决策
legacy adapter 是校园集成的临时防腐层，下一阶段替换时 application 不应发生变化。

...
成员清单
admin.routes.ts: Basic Auth 管理面 HTTP 适配器，聚合 dashboard、公告、日志、Discover、Treehole 管理操作与 UGC 合规模式热开关

架构决策
管理路由只处理 Basic Auth、参数解析、运行策略、错误包装和审计日志；统计、公告和社区管理事实由各 service 维护。

...
grid.tsx / x-axis.tsx / y-axis.tsx / dot.tsx / legend.tsx / tooltip.tsx: 坐标、图例与标记组合部件；Tooltip 仅暴露中性实色表面。
...
变更日志
2026-07-29: Tooltip 去除 frosted-glass 变体，与 Web 的 shadcn neutral 设计令牌对齐。
